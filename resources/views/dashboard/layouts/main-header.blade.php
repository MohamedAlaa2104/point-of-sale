							...
							<li class="">
								<div class="dropdown  nav-itemd-none d-md-flex">
									<a href="#" class="d-flex  nav-item nav-link pl-0 country-flag1" data-toggle="dropdown" aria-expanded="false">
										<span class="avatar country-Flag mr-0 align-self-center bg-transparent"><img src="{{URL::asset('assets/img/flags/'.LaravelLocalization::getCurrentLocale().'_flag.jpg')}}" alt="img"></span>
										<div class="my-auto">
                                    ...
                                    @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                                        ...
                                        <a class="dropdown-item d-flex " rel="alternate" hreflang="{{ $localeCode }}" href="{{ LaravelLocalization::getLocalizedURL($localeCode, null, [], true) }}">
                                            <span class="avatar  ml-3 align-self-center bg-transparent">
                                                <img src="{{URL::asset('assets/img/flags/'.$localeCode.'_flag.jpg')}}" alt="img">
                                            </span>
                                            <div class="d-flex">
...
{{--								 <a class="new nav-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" class="header-icon-svgs" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-mail"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg><span class=" pulse-danger"></span></a>--}}
							...
							<div class="dropdown nav-item main-header-notification">
								...
								<svg xmlns="http://www.w3.org/2000/svg" class="header-icon-svgs" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-bell"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>@if(auth()->user()->unreadNotifications->count())<span class=" pulse"></span>@endif</a>
								<div class="dropdown-menu">

									<div class="menu-header-content bg-primary text-right">
										<div class="d-flex">
											<h6 class="dropdown-title mb-1 tx-15 text-white font-weight-semibold">@lang('dashboard.notifications')</h6>
											<span class="badge badge-pill badge-warning mr-auto my-auto float-left">@lang('dashboard.mark_all_read')</span>
										</div>
										<p class="dropdown-title-text subtext mb-0 text-white op-6 pb-0 tx-12 ">@lang('dashboard.have_notifications', ['num'=>auth()->user()->unreadNotifications->count()])</p>
									</div>

									<div class="main-notification-list Notification-scroll">
										@forelse (auth()->user()->unreadNotifications as $row)
										<a class="d-flex p-3 border-bottom" href="{{ route('dashboard.category.edit', $row->data['categoryId']) }}">

											<div class="mr-3">
												<h5 class="notification-label mb-1">@lang('dashboard.new_category_notification', ['userName' => $row->data['userName'], 'categoryName' => $row->data['categoryName']])</h5>
												<div class="notification-subtext">{{ $row->created_at->diffForHumans() }}</div>
											</div>
											<div class="mr-auto" >
										...
										<a class="d-flex p-3 border-bottom" href="#">
											<div class="mr-3">
												<h5 class="notification-label mb-1">@lang('dashboard.no_notifications')</h5>
											</div>
										</a>
										@endforelse
...
{{--							</div>--}}
							...
							<div class="dropdown main-profile-menu nav nav-item nav-link">
								<a class="profile-user d-flex" href=""><img alt="" src="{{auth()->user()->getFirstMediaUrl('avatar') ? auth()->user()->getFirstMediaUrl('avatar') : URL::asset('assets/img/faces/6.jpg')}}"></a>
								<div class="dropdown-menu">
									<div class="main-header-profile bg-primary p-3">
										<div class="d-flex wd-100p">
											<div class="main-img-user"><img alt="" src="{{auth()->user()->getFirstMediaUrl('avatar') ? auth()->user()->getFirstMediaUrl('avatar') : URL::asset('assets/img/faces/6.jpg')}}" class=""></div>
...
{{--									<a class="dropdown-item" href=""><i class="bx bx-user-circle"></i>Profile</a>--}}
									<a class="dropdown-item" href="{{route('dashboard.users.profile')}}"><i class="bx bx-cog"></i>@lang('dashboard.edit_profile')</a>
{{--									<a class="dropdown-item" href=""><i class="bx bxs-inbox"></i>Inbox</a>--}}
{{--									<a class="dropdown-item" href=""><i class="bx bx-envelope"></i>Messages</a>--}}
{{--									<a class="dropdown-item" href=""><i class="bx bx-slider-alt"></i> Account Settings</a>--}}
									<a class="dropdown-item" href="{{ url('/' . $page='page-signin') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="bx bx-log-out"></i>@lang('dashboard.sign_out')</a>
								</div>
