{{--@can('edit categories')--}}
<a class="link-icon-edit" href="{{route('dashboard.orders.show', $row->id)}}"><i class="fe fe-eye"></i></a>
{{--@endcan--}}
...
{{--        </div>--}}
{{--    </div>--}}
{{--    <form id="delete-form-{{$row->id}}" action="{{route('dashboard.orders.destroy', $row->id)}}" method="POST">--}}
{{--        @method('DELETE')--}}
{{--        @csrf--}}
{{--    </form>--}}
{{--</div>--}}
