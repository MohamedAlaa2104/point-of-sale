    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <h6 class="card-title mb-1">@lang('dashboard.create_new_user')</h6>
                        <p class="text-muted card-sub-title"></p>
                    </div>
                    <form method="POST" action="{{route('dashboard.users.store')}}" class="form-horizontal">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="email" value="{{old('email')}}" class="form-control" id="inputName" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="password" class="form-control" id="inputName" required>
                        </div>
                        <div class="form-group">
                            <p class="mg-b-10">@lang('dashboard.confirm-password')</p>
                            <input type="password" name="password_confirmation" class="form-control" id="inputName" required>
                        </div>
