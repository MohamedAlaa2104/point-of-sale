                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('dashboard.customers.update', $customer->id)}}" class="form-horizontal" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="phone[]" value="{{$customer->phone[0]}}" class="form-control" id="inputName" required>
                        </div>

                        <div class="form-group">
                            <p class="mg-b-10">@lang('dashboard.phone')</p>
                            <input type="number" name="phone[]" value="{{$customer->phone[1]}}" class="form-control" id="inputName">
                        </div>
