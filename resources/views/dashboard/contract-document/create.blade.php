        ...
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form method="POST" action="{{route('dashboard.contract-documents.store')}}" class="form-horizontal" enctype="multipart/form-data" >
                        @csrf
                        <div class=" mg-b-15">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="summernote" name="bands"></textarea>
                            <script>
