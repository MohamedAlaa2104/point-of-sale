    ...
    <a class="link-icon-edit"  href="{{route('dashboard.contract-documents.edit', $row->id)}}"><i class="fe fe-edit"></i></a>
...
{{--        </div>--}}
{{--    </div>--}}
{{--    <form id="delete-form-{{$row->id}}" action="{{route('dashboard.contract-documents.destroy', $row->id)}}" method="POST">--}}
{{--        @method('DELETE')--}}
{{--        @csrf--}}
{{--    </form>--}}
{{--</div>--}}
