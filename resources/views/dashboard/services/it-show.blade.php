    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <h6 class="card-title mb-1">@lang('dashboard.it_requests')</h6>
                    ...
                    <div class="form-group">
                        <p class="mg-b-10">@lang('dashboard.package_type')</p>
                        <input type="text" value="{{$request->package_type}}" disabled class="form-control" id="inputName" required>
                    </div>
                    <div class="form-group">
                        <p class="mg-b-10">@lang('dashboard.message')</p>
                        <textarea type="text" class="form-control" disabled id="inputName" required>{{$request->message}}</textarea>
                    </div>
