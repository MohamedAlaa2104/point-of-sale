...
@section('title', __('dashboard.add_article'))
@section('css')
...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">@lang('dashboard.main')</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ @lang('dashboard.articles')</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <h6 class="card-title mb-1">@lang('dashboard.add_article')</h6>
                        <p class="text-muted card-sub-title"></p>
                    </div>
                    <form method="POST" action="{{route('dashboard.articles.store')}}" class="form-horizontal" enctype="multipart/form-data" >
                        @csrf
                        <div class="form-group">
                            <p class="mg-b-10">@lang('dashboard.title_en')</p>
                            <input type="text" name="title_en" value="{{old('title_en')}}" class="form-control" id="inputName" required>
                        </div>
                        <div class="form-group">
                            <p class="mg-b-10">@lang('dashboard.title_ar')</p>
                            <input type="text" name="title_ar" value="{{old('title_ar')}}" class="form-control" id="inputName" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" name="content_en" class="form-control" id="inputName" required>{{old('content_en')}}</textarea>
                        </div>
                        <div class="form-group">
                            <p class="mg-b-10">@lang('dashboard.content_ar')</p>
                            <textarea type="text" name="content_ar" class="form-control" id="inputName" required>{{old('content_ar')}}</textarea>
                        </div>
                        <div class="mg-b-20">
