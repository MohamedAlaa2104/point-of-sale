            ...
            <div class="card">
                <div class="card-header pb-0">
                    <div class="d-flex justify-content-between">
                        <h4 class="card-title mg-b-0">@lang('dashboard.jobs')</h4>
                    </div>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table text-md-nowrap" id="users-table">
                            ...
                            <tr>
                                ...
                                <th class="wd-15p border-bottom-0"> @lang('dashboard.title') </th>
...
@section('js')
    ...
    <script>
        $('#users-table').DataTable({
            ...
            processing:true,
            serverside:true,
            ajax: '{!! route('dashboard.jobs-table') !!}',
            columns: [
